  ...
  win.document.write(`<!DOCTYPE html><html><head>
    ...
    <style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      body { font-family:Arial,sans-serif; background: #f8fafc; color: #1e1b4b; }
...
💬 Teacher's Comment
  ...
  const handleCopy = async () => {
    ...
    el.style.cssText = 'position:fixed;left:-9999px;top:0;width:600px;background:#fff;padding:24px;font-family:Arial,sans-serif;';
